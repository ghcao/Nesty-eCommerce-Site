	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-9"><!--Main content-->
				<div id="title-bg">
					<div class="title">About Nesty</div>
				</div>
				<div class="page-content">
					<p>
						Nesty is an online E-Commerce platform aimed to small businesses so that they can have a place where they can sell their products and not have to worry about any technical understanding of making or maintaining websites. 
					</p>
					<p>
                                            Nesty aims to bring a new light into small businesses that specialize in certain products, so that consumers can get quality products instead of needing to buy from disreputable brands or big corporations that don't care about quality.
					</p>
				</div>
			</div>
