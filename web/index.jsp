			...
			<div id="sync1" class="owl-carousel">
				...
				<div class="item">
					...
					<div class="slide-desc">
						...
						<div class="inner">
							...
							<p>
								...
								Great jacket for those cold winter months.
							</p>
					...
					<div class="slide-type-1">
                                            <img src="images/StylishJacket.jpg" alt="" class="img-responsive" style="width: 800px; height:330px"/>
					</div>
				</div>
				<div class="item">
                                    <div class="slide-desc">
					...
					<div class="slide-type-1">
                                            <img src="images/iphone.png" alt="" class="img-responsive" style="height: 330px"/>
					</div>
				</div>
				<div class="item">
                                    <div class="slide-desc">
					...
					<div class="slide-type-1">
                                            <img src="images/Note7.jpg" alt="" class="img-responsive" style="height: 330px; width: 800px"/>
					</div>
				</div>
				<div class="item">
					<div class="slide-type-1">
						<img src="images/dummy-1500x700.png" alt="" class="img-responsive"/>
					</div>
				</div>
				<div class="item">
					<div class="slide-type-1">
		...
		<div id="sync2" class="owl-carousel">
			<div class="item">
				<div class="slide-type-1-sync">
					...
					<p>Great Jackets for a Great Price</p>
				</div>
			</div>
			<div class="item">
				<div class="slide-type-1-sync">
					<h3>New IPhone</h3>
					<p>Early Black Friday Deal!!!</p>
				</div>
			</div>
			<div class="item">
				<div class="slide-type-1-sync">
					<h3>New and Improved Galaxy Note 7</h3>
					<p>Won't Explode On You.</p>
				</div>
			</div>
			<div class="item">
				<div class="slide-type-1-sync">
